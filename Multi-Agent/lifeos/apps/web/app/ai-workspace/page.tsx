  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden bg-background text-text-primary font-sans antialiased">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        {/* 2. Redesigned 76px Header */}
        <Header />

        {/* 3. AI Workspace Core Body */}
        <div className="flex flex-1 overflow-hidden">
          {/* Notion-Style Left Conversation & Prompt Panel (260px) */}
          <aside className="hidden lg:flex w-64 flex-col border-r border-border bg-sidebar p-3 space-y-4 select-none shrink-0 overflow-y-auto">
            <Button variant="primary" size="sm" className="w-full justify-start rounded-2xl">
